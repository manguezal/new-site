export let pt = {
        ...
        "about_title": "Sobre",
        "about_content_p1": "<p>MANGUEZAL é uma comunidade de startups do Recife para apoiar práticas  colaborativas e aprendizagem de tecnologia, design e empreendedorismo  em todo o ecossistema de inicialização.</p> <p>Nossos principais objetivos são: (1) promover discussões de alto nível,  eventos e uma programação educacional aprendendo por fazer para atender  às necessidades de empreendedores de alto potencial e avançar no  ecossistema de inicialização em Recife; (2) dar visibilidade aos nossos  startups iniciais apresentando-os a investidores anjos e fundos de capital de risco e (3) estimular o intercâmbio entre as startups do Recife e  outras startups ao redor do mundo.</p>",
        "about_second_title": "❤ ORGULHOSAMENTE FEITO EM RECIFE ❤",
        ...
        "startups_title_startups_registered": "Startups Cadastradas",
        "startups_title_coworking_spaces": "Espaços de Coworking",
        ...
        "newsletter_content_p1": "<p>MANGUEZAL é uma comunidade aberta, se você quiser participar, envie-nos um pedido de pull no nosso repositório github: https://github.com/manguezal/manguezal.github.com</p>",
        "newsletter_title_2": "Newsletter",            
        "newsletter_form_subscribe": "Assinar",

        "footer_stoptalking_startdoing": "Pare de falar <br /> Comece a fazer",
        "footer_br": "BRASIL"
}
